...
namespace Arrowgene.Ddon.Shared.Entity.Structure
{
    public class CDataGachaInfo
    {
        ...
        /// <summary>
        /// Server-side only: Maps DrawGroupId to number of draws for that option
        /// </summary>
        public Dictionary<uint, uint> DrawGroupNumDraws { get; set; }
        ...
        public CDataGachaInfo()
        {
            ...
            Detail = string.Empty;
            WeightDispTitle = string.Empty;
            WeightDispText = string.Empty;
            ListAddr = string.Empty;
            ImageAddr = string.Empty;
            DrawGroups = new List<CDataGachaDrawGroupInfo>();
            DrawGroupNumDraws = new Dictionary<uint, uint>();
        }
